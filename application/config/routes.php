...
$route['penerimaan/hapus_pdf/(:num)']                = 'user/hapus_pdf';
$route['formasi/hapus_pdf/(:num)']                   = 'user/hapus_pdf';
$route['pengangkatan/hapus_pdf/(:num)']              = 'user/hapus_pdf';
$route['kenPangkat/hapus_pdf/(:num)']                = 'user/hapus_pdf';
$route['kenGaji/hapus_pdf/(:num)']                   = 'user/hapus_pdf';
$route['penyMasaKerja/hapus_pdf/(:num)']             = 'user/hapus_pdf';
$route['penyTunj/hapus_pdf/(:num)']                  = 'user/hapus_pdf';
$route['alihtugas/hapus_pdf/(:num)']                 = 'user/hapus_pdf';
$route['kesehatan/hapus_pdf/(:num)']                 = 'user/hapus_pdf';
$route['bansos/hapus_pdf/(:num)']                    = 'user/hapus_pdf';
$route['cuti/hapus_pdf/(:num)']                      = 'user/hapus_pdf';
$route['pensiun/hapus_pdf/(:num)']                   = 'user/hapus_pdf';
$route['pemSendir/hapus_pdf/(:num)']                 = 'user/hapus_pdf';
$route['meninggal/hapus_pdf/(:num)']                 = 'user/hapus_pdf';
$route['instansi/hapus_pdf/(:num)']                  = 'user/hapus_pdf';
$route['diklat/hapus_pdf/(:num)']                    = 'user/hapus_pdf';
