...
<div class="container-fluid">
    ...
    <div class="container bg-white p-4">
        <h1 class="h3 mb-4 text-gray-800 font-weight-bolder">Dokumen - <?= $header['nama']; ?></h1>
        <div class="row">
            <div class="col-lg-8">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-center text-nowrap">Download</th>
                    <?php if ($user['role'] == 'Admin'): ?>
            ...
            <tbody>
                ...
                foreach ($list as $list) : ?>
                    <tr>
                        ...
                        <?php if ($user['role'] == 'Admin'): ?>
                            <td>
                                <a href="<?= base_url($this->uri->slash_segment(1).$this->uri->slash_segment(2)."hapus_pdf/". $list['id']) ?>" class="btn btn-danger d-block mx-auto">Hapus</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
        ...
        <!-- <object data="<?= base_url('assets/')."data_pdf/pdf1.pdf" ?>" type="application/pdf">
            <embed src="<?= base_url('assets/')."data_pdf/pdf1.pdf" ?>" type="application/pdf" />
        </object> -->
    </div>
